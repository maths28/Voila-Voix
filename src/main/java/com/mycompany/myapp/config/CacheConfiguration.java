...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Word.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Word.class.getName() + ".definitions", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Definition.class.getName(), jcacheConfiguration);
