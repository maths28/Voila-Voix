(function () {
    ...
    DemoController.$inject = ['$scope', 'Principal', 'LoginService', '$state', '$resource', 'RestRequest', 'SMService', '$location'];

    function DemoController($scope, Principal, LoginService, $state, $resource, RestRequest, SMService, $location) {
        var vm = this;
        vm.id_analyse = null;
