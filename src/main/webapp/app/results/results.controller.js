(function () {
    ...
    resultController.$inject = ['$scope', 'Principal', 'LoginService', '$state', '$resource', 'RestRequest'];

    function resultController($scope, Principal, LoginService, $state, $resource, RestRequest) {
        var vm = this;
        vm.speakers = [];
        vm.words = [];
        vm.show = false;
