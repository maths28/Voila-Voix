...
import fr.csid.voilavoix.repository.AuthorityRepository;
import fr.csid.voilavoix.repository.PersistentTokenRepository;
import fr.csid.voilavoix.repository.UserRepository;
import fr.csid.voilavoix.security.AuthoritiesConstants;
import fr.csid.voilavoix.service.MailService;
import fr.csid.voilavoix.service.UserService;
import fr.csid.voilavoix.service.dto.UserDTO;
import fr.csid.voilavoix.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testAuthenticatedUser() throws Exception {
        restUserMockMvc.perform(get("/api/authenticate")
                .with(request -> {
                    request.setRemoteUser("sendRequest");
                    return request;
                })
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string("sendRequest"));
    }
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.login").value("sendRequest"))
