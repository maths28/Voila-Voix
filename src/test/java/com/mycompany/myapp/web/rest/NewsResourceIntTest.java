...
public class NewsResourceIntTest {
    ...
    public void createNews() throws Exception {
        ...
        assertThat(testNews.getNews_date()).isEqualTo(DEFAULT_NEWS_DATE);
    ...
    public void getAllNews() throws Exception {
        ...
        restNewsMockMvc.perform(get("/api/news?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].news_date").value(hasItem(sameInstant(DEFAULT_NEWS_DATE))))
    ...
    public void getNews() throws Exception {
        ...
        restNewsMockMvc.perform(get("/api/news/{id}", news.getId()))
            ...
            .andExpect(jsonPath("$.news_date").value(sameInstant(DEFAULT_NEWS_DATE)))
    ...
    public void updateNews() throws Exception {
        ...
        assertThat(testNews.getNews_date()).isEqualTo(UPDATED_NEWS_DATE);
